...
class ZebraJTable extends javax.swing.JTable {
   ...
   public ZebraJTable(java.util.Vector<?> rowData, java.util.Vector<?> columnNames) {
    super(convertToDataArray(rowData), convertToColumnArray(columnNames));
}

private static Object[][] convertToDataArray(java.util.Vector<?> dataVector) {
    Object[][] dataArray = new Object[dataVector.size()][];
    for (int i = 0; i < dataVector.size(); i++) {
        java.util.Vector<?> rowVector = (java.util.Vector<?>) dataVector.get(i);
        dataArray[i] = rowVector.toArray();
    }
    return dataArray;
}

private static Object[] convertToColumnArray(java.util.Vector<?> columnVector) {
    return columnVector.toArray();
}
    /**
